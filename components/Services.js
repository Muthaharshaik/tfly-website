...
const services = [
  ...
  { icon: (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--cyan)" strokeWidth="1.5" strokeLinecap="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>), title: 'Drafting Services', tag: 'CAD / GIS Drafting', desc: 'CAD and GIS drafting of construction drawings, splice diagrams, strand maps, pole loading sheets, and permit drawings in AutoCAD, MicroStation, and ESRI formats.', color: 'rgba(167,139,250,0.07)' },
  { icon: (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--cyan)" strokeWidth="1.5" strokeLinecap="round"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><path d="M18 14v4M14 18h8"/></svg>), title: 'OCAL Services', tag: 'Network Records', desc: 'Outside Cable Assignment List production and management — tracking fiber counts, splice assignments, cable routing, and facility utilization for accurate network records.', color: 'rgba(251,191,36,0.06)' },
